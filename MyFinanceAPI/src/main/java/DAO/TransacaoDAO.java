...
public class TransacaoDAO {
	...
	public List<Transacao> listar(int pagina) throws SQLException {
		...
		try (Connection conn = dataSource.getConnection();
			...
			stmt.setInt(1, chamadosPagina);
			stmt.setInt(2, chamadosPagina * pagina);
			ResultSet rs = stmt.executeQuery();
			while (rs.next()) {
				Transacao t = new Transacao(rs.getInt("id"), rs.getString("descricao"), rs.getDouble("valor"), rs.getString("tipo"), rs.getString("categoria"), rs.getDate("data_criacao").toString());
				transacoes.add(t);
			}
		}
		return transacoes;
	...
	public List<Transacao> buscarTipo(String tipo) throws Exception {
		List<Transacao> transacoes = new ArrayList<>();
	...
	public List<Transacao> buscarCategoria(String categoria) throws Exception {
		List<Transacao> transacoes = new ArrayList<>();
	...
	public List<Transacao> buscarPorCategoriaETipo(String categoria, String tipo) throws Exception {
	...
	public Transacao buscarId(int id) throws Exception {
